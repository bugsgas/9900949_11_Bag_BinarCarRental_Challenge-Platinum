...
function BankOption({ bankData }) {
  const [selectedBank, setSelectedBank] = useState(bankData[0].id);
  const textToCopy = "123456789"; // Update this with the appropriate value from props
  const iconStyle = {
    background: "none",
    border: "none",
    padding: 0,
        ...
        <div className="">
          <Row>
            ...
            <div className="my-2 d-flex">
              ...
              <div>
                <p className="m-0 ps-3">{bankData[0].title} Transfer</p>
